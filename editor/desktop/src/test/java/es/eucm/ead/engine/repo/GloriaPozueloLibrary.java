 ...
 */
public class GloriaPozueloLibrary extends RepoLibraryBuilder {
	/**
	...
	public static void main(String[] args) {
		GloriaPozueloLibrary library = new GloriaPozueloLibrary();
		library.export("D:\\Documents\\TRABAJO\\E-ADVENTURE\\Mockup\\Repo\\gloria");
	}
}

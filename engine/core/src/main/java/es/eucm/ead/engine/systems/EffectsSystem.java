...
public class EffectsSystem extends ConditionalSystem {
	...
	public static final String THIS = VariablesSystem.THIS;
	public static final String EACH = "each " + VariablesSystem.OTHER_ENTITY;
			...
			if (!target.contains("{") || !target.contains("}")) {
				...
				try {
					while (allEntities.hasNext()) {
						...
						if (variablesSystem.evaluateCondition(expression,
								owner, otherEntity, false)) {
